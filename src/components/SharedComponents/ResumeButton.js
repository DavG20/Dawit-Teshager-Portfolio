...
function ResumeButton() {
  return (
    <div className="hidden group md:flex fixed z-10 bottom-6 right-2 gap-4 items-center">
      <div className="text-md text-darker-2  font-medium hidden group-hover:flex px-4 py-2 rounded-xl bg-white">
        RESUME
      </div>
      <a
        href="https://drive.google.com/file/d/1TuyIz08N2EX-v0jg5-SFj4g-ZyiIRp5R/view?usp=drive_link"
